  ...
  return (
    <div
      ...
      <div style={{ position: 'relative', aspectRatio: '16/10', background: run.grad, overflow: 'hidden' }}>
        ...
        <span style={{ position: 'absolute', bottom: 14, left: 14, right: 14, color: '#fff', fontSize: 'clamp(20px, 7vw, 30px)', fontVariationSettings: "'wght' 500", letterSpacing: '-0.6px', textShadow: '0 2px 12px rgba(0,0,0,0.25)', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{run.km} km</span>
      </div>
