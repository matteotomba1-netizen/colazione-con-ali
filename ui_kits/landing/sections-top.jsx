  ...
  return (
    <header style={{
      ...
      <div style={{ width: '100%', maxWidth: 1280, margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <a href="#top" style={{ display: 'flex', alignItems: 'center', gap: 10, color: 'inherit', textDecoration: 'none', fontSize: 19, fontVariationSettings: "'wght' 520", letterSpacing: '-0.4px' }}>
        ...
        <nav style={{ display: 'flex', gap: 30, alignItems: 'center' }}>
          {[['Ricette', '#ricette'], ['Le Corse', '#corse'], ['Chi sono', '#about'], ['Collabora', '#collab']].map(([t, h]) => (
